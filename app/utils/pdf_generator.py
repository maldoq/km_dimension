...
def generate_pdf_poteau(data: dict) -> bytes:
    ...
    add_line("alpha", data.get("alpha"), "")
    add_line("Br", data.get("Br"), "")
    add_line("Ath", data.get("Ath_cent"), "cm²")
    add_line("u", data.get("u"), "")
...
def generate_pdf_semelle(data: dict) -> bytes:
    ...
    add_line("As//A", data.get("As__A"), "m²")
    add_line("As//B", data.get("As__B"), "m²")
